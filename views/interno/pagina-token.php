...
// echo 'Token: ' . $token . '<br>';
// echo 'Token session: ' . $_SESSION['tokenRedefinirSenha'] . '<br>';

if ($token == $_SESSION['tokenRedefinirSenha']) {
} else {
    header("location: $url/");
}
...
$tempo_online = $hora_atual - $_SESSION['horaCriacaoToken'];

$url = URL_BASE;

$tempo_online < 900 ?: header("location: $url/logout");
...
<head>
    ...
    <title>Alumni - Redefinir senha</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Redefinir senha | Alumni</h1>
                                    </div>
    ...
    <script>
        function enviar() {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'html',
                url: '<?= $url ?>/data/redefinir-senha-token',
