                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-danger">Cpf não existe na base de dados!</h1>
                                <p class="mb-3">
                                    Preencha o formulario para verificar arquivos! <strong>Um email será enviado</strong>
                                </p>
                            </div>
                            ...
                            <form class="user needs-validation">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="ano" placeholder="Ano">
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="curso" placeholder="Curso">
                                </div>
                                <div class="form-group row">
