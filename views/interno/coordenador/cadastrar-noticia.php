            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="p-5">
                        ...
                        <form class="user needs-validation" enctype="multipart/form-data">
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user" id="titulo" placeholder="Titulo">
                                </div>
                                <div class="col-sm-6">
                                    <label for="file" class="form-control form-control-user">Upload de foto</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-user" id="descricao" rows="2"></textarea>
                            </div>
                            <!-- <div class="form-group row">
    ...
    <script>
        function enviar() {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'html',
                url: '<?= $url ?>/data/cadastrar-noticia',
