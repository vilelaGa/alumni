...
$CodigoCurso = (new DbInsercao())->selectValidaCpf($dados['CPF'])->fetch(PDO::FETCH_ASSOC);

// echo $CodigoCurso['cr_codigo'];

$NomeCursoAluno = (new DbInsercao())->selectNomeCurso($CodigoCurso['cr_codigo'])->fetch(PDO::FETCH_ASSOC);

// echo($NomeCursoAluno['nome']);
                ...
                <div class="container-fluid">
                    ...
                    <div class="p-5">
                        ...
                        <form class="user">
                            ...
                            <div class="form-group">
                                <label>CURSO:</label>
                                <input type="text" class="form-control form-control-user" placeholder="<?= $NomeCursoAluno['nome'] ?>" disabled>
                            </div>
